...
TEST_CASE("pick_ik::make_pose_cost_fn") {
    ...
    SECTION("Test 0 - sample data taken from instrumenting bio_ik") {
        auto const goal =
            pick_ik::Frame{tf2::Vector3(0.3548182547092438, -0.04776066541671753, 0.5902695655822754),
                  tf2::Quaternion(0.9239557003781338,
                                  -0.38249949508300274,
                                  1.324932598914536e-12,
                                  3.2004117980888137e-12)};
        auto const frame =
            pick_ik::Frame{tf2::Vector3(0.3363926217416014, -0.043807946580255344, 0.5864240526436293),
        ...
        auto const goal =
            pick_ik::Frame{tf2::Vector3(0.3548182547092438, -0.04776066541671753, 0.5902695655822754),
                  tf2::Quaternion(0.9239557003781338,
                                  ...
                                  3.2004117980888137e-12)};
        auto const frame =
            pick_ik::Frame{tf2::Vector3(0.3548171636285567, -0.04776037000115037, 0.590266184369505),
